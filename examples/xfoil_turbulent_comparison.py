...
results for a NACA 0012 airfoil using the XFoil edge velocity profile.

Created on Tue Aug 30 22:36:45 2022
...
def compare_xfoil_turbulent():
    ...
    hm_visc = HeadMethod(U_e = [s_ref, U_e_visc])
    ...
    iinv = 0
    hm_inv = HeadMethod(U_e = [s_ref, U_e_inv])
