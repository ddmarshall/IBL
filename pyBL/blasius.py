...
class BlasiusSolution:
    ...
    One the solution is obtained, the dense output from the ODE integrator is
    ...
    def fpp(self, eta):
        """
        Return the derivative of the non-dimensional velocity from
        the solution.
    ...
    def eta(self, x, y):
        """
        Return the similarity coordinate that corresponds to the Cartesian
        coordinates.
    ...
    def U_e(self, x):
        """
        Return the edge streamwise velocity at the corresponding streamwise
        locations.
